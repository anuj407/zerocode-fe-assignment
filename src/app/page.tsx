...
export default function HomePage() {
  ...
  return (
    <div className={`flex flex-col w-screen ${darkMode ? "dark bg-gray-900 text-white" : "bg-gray-50 text-black"}`}>
      ...
      <div className="flex flex-1 min-h-[calc(100vh-64px)] relative">
        ...
        {sidebarOpen && (
          <div className="fixed inset-0 z-40 bg-black bg-opacity-40 sm:hidden" onClick={() => setSidebarOpen(false)}>
            <div
